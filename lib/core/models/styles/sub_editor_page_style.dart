...
class SubEditorPageStyle {
  /// Creates a [SubEditorPageStyle].
  ///
  ...
  /// Creates a copy of this `SubEditorPageStyle` object with the given fields
  /// replaced with new values.
  ///
  /// The [copyWith] method allows you to create a new instance of
  /// [SubEditorPageStyle] with some properties updated while keeping the
  /// others unchanged.
