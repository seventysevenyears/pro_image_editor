...
/// The `TemplateEditorStyle` class defines the style for the template editor in
/// the image editor.
...
///
/// ```dart
/// TemplateEditorStyle TemplateEditorStyle = TemplateEditorStyle(
/// );
/// ```
///
/// Properties:
...
class TemplateEditorStyle {
  ...
  /// the modal bottom sheet displaying the [TemplateEditor].
  ///
