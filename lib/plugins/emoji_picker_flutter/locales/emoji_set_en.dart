...
const List<CategoryEmoji> emojiSetEnglish = [
  ...
  CategoryEmoji(Category.SYMBOLS, [
    ...
    Emoji('❣️', 'exclamation | heart | heavy | mark | punctuation '),
    Emoji(
      '💔',
      'break | broken | crushed | emotion | heart | heartbroken | lonely | sad',
    ),
    Emoji('❤️‍🔥', 'emotion | heart | fire | fiery | love | red'),
    ...
    Emoji('❕', '! | exclamation | mark | outlined | punctuation | white'),
    Emoji('❗', '! | exclamation | mark | punctuation | red'),
    Emoji('©️', 'C | copyright '),
