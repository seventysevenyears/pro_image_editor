...
class Image extends Iterable<Pixel> {
  ...
  Image.fromResized(
    ...
    _createImageData(width, height, other.numChannels, other.palette);
  ...
  void _initialize(
    ...
    if (palette == null && withPalette && supportsPalette) {
      palette = _createPalette(format, numChannels);
    }
    _createImageData(width, height, numChannels, palette);
  }
  ...
  Palette? _createPalette(Format format, int numChannels) {
