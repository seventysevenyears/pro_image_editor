...
/// either `ImageEditorDesignMode.cupertino` or
...
class PlatformPopupBtn extends StatefulWidget {
  ...
  ///   designMode: ImageEditorDesignMode.android,
  ///   title: 'Options',
  ...
  /// such as Android or iOS, by using the [ImageEditorDesignMode] enumeration.
