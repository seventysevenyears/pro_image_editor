...
class TemplateLayerExportConfigs {
  ...
  /// {@endtemplate}
  const TemplateLayerExportConfigs({
    this.id,
    this.networkUrl,
    this.assetPath,
    this.fileUrl,
  ...
  factory TemplateLayerExportConfigs.fromMap(Map<String, dynamic>? map) {
    map ??= {};
    return TemplateLayerExportConfigs(
      id: map['id'],
  ...
  /// The width of the widget to restore it.
  final double? width;

  /// The height of the widget to restore it.
  final double? height;
  ...
  TemplateLayerExportConfigs copyWith({
    String? id,
    String? networkUrl,
    String? assetPath,
    String? fileUrl,
