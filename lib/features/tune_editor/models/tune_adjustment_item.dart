...
class TuneAdjustmentItem {
  ...
  /// Converts the current `TuneAdjustmentItem` to a `TuneAdjustmentMatrix`
  /// object.
  ///
  /// The resulting `TuneAdjustmentMatrix` will have the same `id` as the
  /// current item, a `value` of 0, and a `matrix` generated by calling
  /// `toMatrix(0)`.
  ///
  /// Returns:
